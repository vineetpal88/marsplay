...
public class Resizer {
    ...
    public File getResizedFile() throws IOException {
        return getScaledImage(targetLength, quality, compressFormat, outputDirPath, outputFilename,
                sourceImage);
    }
    ...
    public Bitmap getResizedBitmap() throws IOException {
        return getScaledBitmap(targetLength, sourceImage);
    }

    public File getScaledImage(int targetLength, int quality, Bitmap.CompressFormat compressFormat,
    ...
    public String getOutputFilePath(Bitmap.CompressFormat compressFormat, String outputDirPath, String outputFilename, File sourceImage) {
    ...
    public void writeBitmapToFile(Bitmap bitmap, Bitmap.CompressFormat compressFormat, int quality, String filePath) throws IOException {
    ...
    public Bitmap getScaledBitmap(int targetLength, File sourceImage) {
        BitmapFactory.Options options = new BitmapFactory.Options();
        options.inJustDecodeBounds = false;
        long length = sourceImage.length();
        ...
        //Bitmap orientedBitmap = ExifUtil.rotateBitmap(sourceImage.getAbsolutePath(), bitmap);
